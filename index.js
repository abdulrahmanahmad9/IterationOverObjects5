const fruits = [
  ...
  **********/
  ...
  function countSweetFruits(fruits,taste) {
    // Your code here
    const goodTaste = fruits.filter(fruit => fruit.taste === taste );
    return goodTaste.length;

  }
  console.log(countSweetFruits(fruits,"Sweet"));